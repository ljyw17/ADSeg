...
class SwinTransformerSys(nn.Module):
    ...
    def forward_features(self, x):
        ...
        x0_1 = self.conv0_1(dbfm([x_downsample[0].permute(0, 3, 1, 2), self.my_up(x_downsample[1].permute(0, 3, 1, 2))], 1))
        x1_1 = self.conv1_1(dbfm([x_downsample[1].permute(0, 3, 1, 2), self.my_up(x_downsample[2].permute(0, 3, 1, 2))], 1))
        x0_2 = self.conv0_2(dbfm([x_downsample[0].permute(0, 3, 1, 2), x0_1, self.my_up(x1_1)], 1))

        x2_1 = self.conv2_1(dbfm([x_downsample[2].permute(0, 3, 1, 2), self.my_up(x_downsample[4].permute(0, 3, 1, 2))], 1))
        x1_2 = self.conv1_2(dbfm([x_downsample[1].permute(0, 3, 1, 2), x1_1, self.my_up(x2_1)], 1))
        x0_3 = self.conv0_3(dbfm([x_downsample[0].permute(0, 3, 1, 2), x0_1, x0_2, self.my_up(x1_2)], 1))
